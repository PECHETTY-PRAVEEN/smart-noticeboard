            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>View Image Records</div>
                            <div class="card-body">
...
?>
    <td><img src="uploads/<?php echo $row['imagename']; ?>" class="img-thumbnail" width="100px" height="150px"></td>
  <?php
    ...
    ?>
    <td height="50px" ><form method="post" ><button onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-primary" id="delete" name="delete" value="<?php echo $row['imageid']; ?>">Delete</button></form></td>
...
<select class="form-control" id="priority" name="priority">
      ...
      <br>                                             
    <button onclick="return confirm('Are you sure you want to change priority this item?');" id="change" name="change" class="btn btn-primary" value="<?php echo $row['imageid']; ?>">Change</button>
...
if (isset($_POST['delete'])) {
    ...
    $sql="DELETE From images Where imageid='".$_POST['delete']."' ";
    $result = mysqli_query($con, $sql);
        if ($result) {
...
$sql = "UPDATE `images` SET `priority` = '".$_POST['priority']."',`userup` = '".$_SESSION['name']."' WHERE `images`.`imageid` = ".$_POST['change']."";
$result = mysqli_query($con, $sql);
        if ($result) {
