            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Upload text</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Upload Text</li>
                        </ol>
<!-- login -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">  Upload Text</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="#" enctype="multipart/form-data">
                                            <div class="form-group"><label class="small mb-1" for="text">Enter Text:</label><input class="form-control py-4" type="text" name="text" id="text"></div>
    ...
    if(isset($_POST['submit'])){
        $text=$_POST['text'];
         $priority  =   $_POST['priority'];
             $insert="INSERT INTO `texts` (`text`,`priority`) VALUES ('$text','$priority')";
