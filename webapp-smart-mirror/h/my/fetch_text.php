...
<div class="table table-striped">
	<table style="width: 100%" class="table-bordered" align="left" id="table1" style="text-align:center;">
<thead>	
	<tr>
		<th style="text-align: center;" width="25%" >  s no  </th>
		<th width="50%" style="text-align: center;">  Data   </th>
