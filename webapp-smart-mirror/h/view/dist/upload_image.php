                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">  Upload Image</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="#" enctype="multipart/form-data">
                                            <div class="form-group"><label class="small mb-1" for="file">Select image:</label><input class="form-control" type="file" name="file" id="file"></div>
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($name) and !empty($name)){
            ...
            if(move_uploaded_file($temp_name, $location)){
             $insert="INSERT INTO `images` (`imagename`,`image`,`priority`) VALUES ('$name', '$temp_name','$priority')";
